...
session_save_path($root.'/storage/sessions'); session_name('canteen_session'); session_set_cookie_params(['lifetime'=>$authCookieLifetime,'httponly'=>true,'samesite'=>'Lax','secure'=>(!empty($_SERVER['HTTPS'])&&$_SERVER['HTTPS']!=='off')]); session_start();
